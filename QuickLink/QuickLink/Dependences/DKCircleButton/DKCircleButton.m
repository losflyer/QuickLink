...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _circleBorderColor = [UIColor whiteColor];
        _animateTap = YES;
...
- (void)setCircleBorderColor:(UIColor *)borderColor {
    _circleBorderColor = borderColor;
    [self layoutSubviews];
}
...
- (void)setHighlighted:(BOOL)highlighted {
    ...
    if (highlighted) {
        self.layer.borderColor = [self.circleBorderColor colorWithAlphaComponent:1.0].CGColor;
        
        [self triggerAnimateTap];
    }
    else {
        self.layer.borderColor = [self.circleBorderColor colorWithAlphaComponent:0.7].CGColor;
    }
}
...
- (void)triggerAnimateTap {
    ...
    circleShape.fillColor = [UIColor clearColor].CGColor;
    circleShape.opacity = 0;
    self.circleBorderColor = [UIColor redColor];
    circleShape.strokeColor = self.circleBorderColor.CGColor;
